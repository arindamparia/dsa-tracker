...
export default async (request, context) => {
  try {
    ...
    // If solved <= 1, suggest a random unsolved problem before sleep
    ...
    // ── Motivational messages (randomised) ───────────────────────────
    const motivations = [
    ...
    // ── Suggestion block (shown when solvedToday <= 1) ────────────────
          ...
          <tr>
            <td style="background:#111118;border-radius:14px;border:1px solid #2a2a3e;overflow:hidden;">
              ...
              <div style="padding:28px 28px 10px;">
                ...
                <h1 style="margin:0 0 8px;font-size:26px;font-weight:700;color:#e8e8f0;line-height:1.2;">Good Night, Arindam &#127769;</h1>
